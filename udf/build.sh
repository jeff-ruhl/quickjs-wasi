...
export LIBS="${LIBS} -L/opt/lib -lwasi_vfs -L${WASI_SDK_PATH}/share/wasi-sysroot/lib/wasm32-wasi -lwasi-emulated-signal --sysroot=${WASI_SDK_PATH}/share/wasi-sysroot -lcrypt -lm -lwasi-emulated-mman -lwasi-emulated-signal -lwasi-emulated-getpid -lwasi-emulated-process-clocks -lc -lwasix"
